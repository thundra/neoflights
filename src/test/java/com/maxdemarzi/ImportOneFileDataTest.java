...
public class ImportOneFileDataTest {
    ...
    @Test
    public void shouldImportAllData() {
        ...
        assertTrue(message.startsWith("100 All data imported in "));
    }


    private static final HashMap<String, Object> PARAMS = new HashMap<String, Object>(){{
        put("file", "/home/thundera/projects/upwork/neoflights_new/src/main/resources/data/sample_data.csv");
    }};
    ...
    private static final HashMap<String, Object> QUERY = new HashMap<String, Object>(){{
        put("statements", new ArrayList<Map<String, Object>>() {{
            add(new HashMap<String, Object>() {{
                put("statement", "CALL com.maxdemarzi.import.importOneFileData({file})");
